...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            first_line = itemView.findViewById(R.id.Name);
            second_line = itemView.findViewById(R.id.Message);
            container = itemView.findViewById(R.id.MessageBox);
        }
    }
    ...
    */
    public void onBindViewHolder(@NonNull MyAdapter.ViewHolder holder, final int position) {
        try {
            ...
            final String mFirstLine = element.getString("sendby");
            final String mSecondLine = element.getString("message");
